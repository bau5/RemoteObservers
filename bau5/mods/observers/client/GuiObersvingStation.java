...
public class GuiObersvingStation extends GuiContainer{
	...
	public GuiObersvingStation(EntityPlayer player, TileEntityMonitoringStation te) {
	...
	protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
		if(!initialized){
			buttonList.add(new ScrollButton(0, 185, 59));
			buttonList.add(new ScrollButton(1, 226, 59));
		}
